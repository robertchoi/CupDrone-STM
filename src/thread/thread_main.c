...
void thread_main(void)
{
    ...
    osThreadDef(TASK3, thread_nrf,  osPriorityNormal, 0, configMINIMAL_STACK_SIZE);
    ...
    Thread_Handle_nrf  = osThreadCreate(osThread(TASK3), NULL);
